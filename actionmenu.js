(function($) {
    $.fn.extend({
        "actionmenu": function(actions) {
            $(this).bind('click', function(e) {
                e.stopPropagation();
                launch_menu(this, actions);
            });
        }
    });
})(jQuery);

function launch_menu(item, data) {

    var bt_el = $(item);//.find("div.option");
    ...
    var status_list_html = template({ "action_groups": data });
